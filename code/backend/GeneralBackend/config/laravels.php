...
return [
    ...
    */
    ...
    'processes' => [
        // 'Collection_Spot_Depth' => [
        //     'class' => \App\SwooleWebsocket\Spot\Huobi\Depth::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline' => [
        //     'class' => \App\SwooleWebsocket\Spot\Huobi\Kline::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Market' => [
        //     'class' => \App\SwooleWebsocket\Spot\Huobi\Market::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Trade' => [
        //     'class' => \App\SwooleWebsocket\Spot\Huobi\Trade::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],

        // 'Collection_Swap_Depth' => [
        //     'class' => \App\SwooleWebsocket\Swap\Huobi\Depth::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline' => [
        //     'class' => \App\SwooleWebsocket\Swap\Huobi\Kline::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Market' => [
        //     'class' => \App\SwooleWebsocket\Swap\Huobi\Market::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Trade' => [
        //     'class' => \App\SwooleWebsocket\Swap\Huobi\Trade::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // OKEX行情采集脚本
        // 'Collection_Spot_Kline' => [
        //     'class' => \App\SwooleWebsocket\Spot\Okex\Kline::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Depth' => [
        //     'class' => \App\SwooleWebsocket\Spot\Okex\Depth::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Market' => [
        //     'class' => \App\SwooleWebsocket\Spot\Okex\Market::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Trade' => [
        //     'class' => \App\SwooleWebsocket\Spot\Okex\Trade::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 'Collection_Swap_Kline' => [
        //     'class' => \App\SwooleWebsocket\Swap\Okex\Kline::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Depth' => [
        //     'class' => \App\SwooleWebsocket\Swap\Okex\Depth::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Market' => [
        //     'class' => \App\SwooleWebsocket\Swap\Okex\Market::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Trade' => [
        //     'class' => \App\SwooleWebsocket\Swap\Okex\Trade::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 币安行情采集
        // 'Collection_Spot_Depth' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Depth::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 'Collection_Spot_Kline' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],

        // 'Collection_Spot_Kline1m' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline1m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline5m' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline5m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline15m' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline15m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline30m' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline30m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline1h' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline1h::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline4h' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline4h::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline1d' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline1d::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Kline1w' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Kline\Kline1w::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 'Collection_Spot_Market' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Market::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Spot_Trade' => [
        //     'class' => \App\SwooleWebsocket\Spot\Binance\Trade::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 'Collection_Swap_Depth' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Depth::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 'Collection_Swap_Kline1m' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline1m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline5m' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline5m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline15m' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline15m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline30m' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline30m::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline1h' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline1h::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline4h' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline4h::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline1d' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline1d::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Kline1w' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Kline\Kline1w::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        ...
        // 'Collection_Swap_Market' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Market::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
        // 'Collection_Swap_Trade' => [
        //     'class' => \App\SwooleWebsocket\Swap\Binance\Trade::class,
        //     'redirect' => false, //是否重定向输入输出
        //     'pipe'  => 0, // 管道类型： 0不创建管道，1创建SOCK_STREAM类型管道， 2创建SOCK_DGRAM类型管道
        //     'enable' => true,   //是否启用，默认true
        // ],
    ...
    */
    ...
    'timer' => [
        ...
        'jobs'            => [
            ...
            App\Jobs\Timer\WebsocketHeartbeat::class,
            Hhxsv5\LaravelS\Illuminate\LaravelScheduleJob::class,
            App\Jobs\Timer\Spot\IndexMarketList::class,
            App\Jobs\Timer\Spot\SceneListNewPrice::class,
            App\Jobs\Timer\Spot\AirCoin::class,
            App\Jobs\Timer\Swap\AirCoin::class,
            App\Jobs\Timer\Swap\SwapMarketList::class,
        ],
