...
@import '../common/index.css';.van-panel{background:#fff;background:var(--panel-background-color,#fff)}.van-panel__header-value{color:#ce5b67;color:var(--panel-header-value-color,#ce5b67)}.van-panel__footer{padding:8px 16px;padding:var(--panel-footer-padding,8px 16px)}
</style>